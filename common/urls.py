...
from .api import CategoryViewset, CategoryUploadViewSet, ItemsViewSet, TablesViewSet,CategoryImageViewSet, ItemImageViewSet, TableImageViewSet, TypeViewSet, ProfileGet
...
router.register('api/getprofile', ProfileGet, 'getprofile')
